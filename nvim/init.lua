...
ensure_installed = {'bash', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'yaml', 'vim','cmake','json','latex','markdown','make','toml','comment','dockerfile','diff', 'vimdoc','tree-sitter-diff'},
